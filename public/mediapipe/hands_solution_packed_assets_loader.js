      ...
      function fetchRemotePackage(packageName, packageSize, callback, errback) {
        ...
        xhr.onprogress = function(event) {
          ...
          if (event.loaded) {
            ...
            total = Math.ceil(total * Module.expectedDataFileDownloads/Math.max(1, num));
            if (Module['setStatus']) Module['setStatus']('Downloading data... (' + loaded + '/' + total + ')');
          } else if (!Module || !Module.dataFileDownloads) {
            if (Module && Module['setStatus']) Module['setStatus']('Downloading data...');
          }
        };
